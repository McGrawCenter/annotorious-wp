jQuery(document).ready(function($) {
	...
	jQuery.fn.upload_listing_image = function( button ) {
		...
		file_frame.on( 'select', function() {
		  ...
		  jQuery("#annotoriusimagediv img").attr('src',attachment.url);
		  jQuery( '#annotoriusimagediv img' ).show();
	...
	jQuery('#annotoriusimagediv').on( 'click', '#upload_listing_image_button', function( event ) {
		event.preventDefault();
		jQuery.fn.upload_listing_image( jQuery(this) );
	});

	jQuery('#annotoriusimagediv').on( 'click', '#remove_listing_image_button', function( event ) {
		event.preventDefault();
		jQuery( '#upload_listing_image' ).val( '' );
		jQuery( '#annotoriusimagediv img' ).attr( 'src', '' );
		jQuery( '#annotoriusimagediv img' ).hide();
